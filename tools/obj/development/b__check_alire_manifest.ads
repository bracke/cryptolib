...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_check_alire_manifest" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#c317b3c3#;
   pragma Export (C, u00001, "check_alire_manifestB");
   ...
   u00136 : constant Version_32 := 16#927c01c5#;
   pragma Export (C, u00136, "system__finalization_primitivesS");
   u00137 : constant Version_32 := 16#e8108c8c#;
   pragma Export (C, u00137, "system__os_locksS");
   u00138 : constant Version_32 := 16#fbeae7f4#;
   ...
   u00140 : constant Version_32 := 16#377f12dc#;
   pragma Export (C, u00140, "project_toolsS");
   u00141 : constant Version_32 := 16#d3a0a796#;
   pragma Export (C, u00141, "project_tools__alire_manifestsB");
   u00142 : constant Version_32 := 16#8fca1293#;
   pragma Export (C, u00142, "project_tools__alire_manifestsS");
   u00143 : constant Version_32 := 16#01c24865#;
   pragma Export (C, u00143, "project_tools__alire_manifests__stagingB");
   u00144 : constant Version_32 := 16#3a6033e4#;
   pragma Export (C, u00144, "project_tools__alire_manifests__stagingS");
   u00145 : constant Version_32 := 16#85b92d20#;
   pragma Export (C, u00145, "ada__directoriesB");
   u00146 : constant Version_32 := 16#c1305a6c#;
   pragma Export (C, u00146, "ada__directoriesS");
   u00147 : constant Version_32 := 16#78511131#;
   pragma Export (C, u00147, "ada__calendarB");
   u00148 : constant Version_32 := 16#c907a168#;
   pragma Export (C, u00148, "ada__calendarS");
   u00149 : constant Version_32 := 16#d172d809#;
   pragma Export (C, u00149, "system__os_primitivesB");
   u00150 : constant Version_32 := 16#13d50ef9#;
   pragma Export (C, u00150, "system__os_primitivesS");
   u00151 : constant Version_32 := 16#c1ef1512#;
   pragma Export (C, u00151, "ada__calendar__formattingB");
   u00152 : constant Version_32 := 16#5a9d5c4e#;
   pragma Export (C, u00152, "ada__calendar__formattingS");
   u00153 : constant Version_32 := 16#974d849e#;
   pragma Export (C, u00153, "ada__calendar__time_zonesB");
   u00154 : constant Version_32 := 16#55da5b9f#;
   pragma Export (C, u00154, "ada__calendar__time_zonesS");
   u00155 : constant Version_32 := 16#0a4a0a25#;
   pragma Export (C, u00155, "system__val_fixed_64S");
   u00156 : constant Version_32 := 16#afdc38b2#;
   pragma Export (C, u00156, "system__arith_64B");
   u00157 : constant Version_32 := 16#509fabdd#;
   pragma Export (C, u00157, "system__arith_64S");
   u00158 : constant Version_32 := 16#aa0160a2#;
   pragma Export (C, u00158, "system__val_intS");
   u00159 : constant Version_32 := 16#5da6ebca#;
   pragma Export (C, u00159, "system__val_unsS");
   u00160 : constant Version_32 := 16#c3b32edd#;
   pragma Export (C, u00160, "ada__containers__helpersB");
   u00161 : constant Version_32 := 16#444c93c2#;
   pragma Export (C, u00161, "ada__containers__helpersS");
   u00162 : constant Version_32 := 16#52627794#;
   pragma Export (C, u00162, "system__atomic_countersB");
   u00163 : constant Version_32 := 16#c83084cc#;
   pragma Export (C, u00163, "system__atomic_countersS");
   u00164 : constant Version_32 := 16#1dec9118#;
   pragma Export (C, u00164, "ada__directories__hierarchical_file_namesB");
   u00165 : constant Version_32 := 16#34d5eeb2#;
   pragma Export (C, u00165, "ada__directories__hierarchical_file_namesS");
   u00166 : constant Version_32 := 16#ab4ad33a#;
   pragma Export (C, u00166, "ada__directories__validityB");
   u00167 : constant Version_32 := 16#0877bcae#;
   pragma Export (C, u00167, "ada__directories__validityS");
   u00168 : constant Version_32 := 16#96a20755#;
   pragma Export (C, u00168, "ada__strings__fixedB");
   u00169 : constant Version_32 := 16#11b694ce#;
   pragma Export (C, u00169, "ada__strings__fixedS");
   u00170 : constant Version_32 := 16#b40d9bf2#;
   pragma Export (C, u00170, "ada__strings__searchB");
   u00171 : constant Version_32 := 16#97fe4a15#;
   pragma Export (C, u00171, "ada__strings__searchS");
   u00172 : constant Version_32 := 16#4259a79c#;
   pragma Export (C, u00172, "ada__strings__unboundedB");
   u00173 : constant Version_32 := 16#b40332b4#;
   pragma Export (C, u00173, "ada__strings__unboundedS");
   u00174 : constant Version_32 := 16#d79db92c#;
   pragma Export (C, u00174, "system__return_stackS");
   u00175 : constant Version_32 := 16#756a1fdd#;
   pragma Export (C, u00175, "system__stream_attributesB");
   u00176 : constant Version_32 := 16#a8236f45#;
   pragma Export (C, u00176, "system__stream_attributesS");
   u00177 : constant Version_32 := 16#1c617d0b#;
   pragma Export (C, u00177, "system__stream_attributes__xdrB");
   u00178 : constant Version_32 := 16#e4218e58#;
   pragma Export (C, u00178, "system__stream_attributes__xdrS");
   u00179 : constant Version_32 := 16#d71ab463#;
   pragma Export (C, u00179, "system__fat_fltS");
   u00180 : constant Version_32 := 16#f128bd6e#;
   pragma Export (C, u00180, "system__fat_lfltS");
   u00181 : constant Version_32 := 16#8bf81384#;
   pragma Export (C, u00181, "system__fat_llfS");
   u00182 : constant Version_32 := 16#aaf681ed#;
   pragma Export (C, u00182, "system__file_attributesS");
   u00183 : constant Version_32 := 16#8f8e85c2#;
   pragma Export (C, u00183, "system__regexpB");
   u00184 : constant Version_32 := 16#371accc3#;
   pragma Export (C, u00184, "system__regexpS");
   u00185 : constant Version_32 := 16#35d6ef80#;
   pragma Export (C, u00185, "system__storage_poolsB");
   u00186 : constant Version_32 := 16#8e431254#;
   pragma Export (C, u00186, "system__storage_poolsS");
   u00187 : constant Version_32 := 16#b1e8a6ae#;
   pragma Export (C, u00187, "project_tools__filesB");
   u00188 : constant Version_32 := 16#8734643b#;
   pragma Export (C, u00188, "project_tools__filesS");
   u00189 : constant Version_32 := 16#8d235f7e#;
   pragma Export (C, u00189, "ada__environment_variablesB");
   u00190 : constant Version_32 := 16#767099b7#;
   pragma Export (C, u00190, "ada__environment_variablesS");
   u00191 : constant Version_32 := 16#58c21abc#;
   pragma Export (C, u00191, "interfaces__c__stringsB");
   u00192 : constant Version_32 := 16#bd4557ce#;
   pragma Export (C, u00192, "interfaces__c__stringsS");
   u00193 : constant Version_32 := 16#2252a12d#;
   pragma Export (C, u00193, "ada__streams__stream_ioB");
   u00194 : constant Version_32 := 16#5dc4c9e4#;
   pragma Export (C, u00194, "ada__streams__stream_ioS");
   u00195 : constant Version_32 := 16#5de653db#;
   pragma Export (C, u00195, "system__communicationB");
   u00196 : constant Version_32 := 16#bb9c8d3c#;
   pragma Export (C, u00196, "system__communicationS");
   u00197 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00197, "gnatS");
   u00198 : constant Version_32 := 16#40fe4806#;
   pragma Export (C, u00198, "gnat__regexpS");
   u00199 : constant Version_32 := 16#3f48f1e0#;
   pragma Export (C, u00199, "project_tools__linksB");
   u00200 : constant Version_32 := 16#e9bbd0e5#;
   pragma Export (C, u00200, "project_tools__linksS");
   u00201 : constant Version_32 := 16#656efae9#;
   pragma Export (C, u00201, "gnat__os_libS");
   u00202 : constant Version_32 := 16#f2d07175#;
   pragma Export (C, u00202, "project_tools__textB");
   u00203 : constant Version_32 := 16#95ccbf63#;
   ...
   u00214 : constant Version_32 := 16#3d0de099#;
   pragma Export (C, u00214, "project_tools__alire_manifests__validationB");
   u00215 : constant Version_32 := 16#68397289#;
   pragma Export (C, u00215, "project_tools__alire_manifests__validationS");
