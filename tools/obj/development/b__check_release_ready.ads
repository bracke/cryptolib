...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_check_release_ready" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#96403489#;
   pragma Export (C, u00001, "check_release_readyB");
   ...
   u00104 : constant Version_32 := 16#96a20755#;
   pragma Export (C, u00104, "ada__strings__fixedB");
   u00105 : constant Version_32 := 16#11b694ce#;
   pragma Export (C, u00105, "ada__strings__fixedS");
   u00106 : constant Version_32 := 16#b40d9bf2#;
   pragma Export (C, u00106, "ada__strings__searchB");
   u00107 : constant Version_32 := 16#97fe4a15#;
   ...
   u00124 : constant Version_32 := 16#27ac21ac#;
   pragma Export (C, u00124, "ada__text_ioB");
   u00125 : constant Version_32 := 16#04ab031f#;
   pragma Export (C, u00125, "ada__text_ioS");
   u00126 : constant Version_32 := 16#b228eb1e#;
   pragma Export (C, u00126, "ada__streamsB");
   u00127 : constant Version_32 := 16#613fe11c#;
   pragma Export (C, u00127, "ada__streamsS");
   u00128 : constant Version_32 := 16#05222263#;
   pragma Export (C, u00128, "system__put_imagesB");
   u00129 : constant Version_32 := 16#08866c10#;
   pragma Export (C, u00129, "system__put_imagesS");
   u00130 : constant Version_32 := 16#22b9eb9f#;
   pragma Export (C, u00130, "ada__strings__text_buffers__utilsB");
   u00131 : constant Version_32 := 16#89062ac3#;
   pragma Export (C, u00131, "ada__strings__text_buffers__utilsS");
   u00132 : constant Version_32 := 16#1cacf006#;
   pragma Export (C, u00132, "interfaces__c_streamsB");
   u00133 : constant Version_32 := 16#d07279c2#;
   pragma Export (C, u00133, "interfaces__c_streamsS");
   u00134 : constant Version_32 := 16#ec2f4d1e#;
   pragma Export (C, u00134, "system__file_ioB");
   u00135 : constant Version_32 := 16#72673e49#;
   pragma Export (C, u00135, "system__file_ioS");
   u00136 : constant Version_32 := 16#c34b231e#;
   pragma Export (C, u00136, "ada__finalizationS");
   u00137 : constant Version_32 := 16#d00f339c#;
   pragma Export (C, u00137, "system__finalization_rootB");
   u00138 : constant Version_32 := 16#1e5455db#;
   pragma Export (C, u00138, "system__finalization_rootS");
   u00139 : constant Version_32 := 16#ef3c5c6f#;
   pragma Export (C, u00139, "system__finalization_primitivesB");
   u00140 : constant Version_32 := 16#927c01c5#;
   pragma Export (C, u00140, "system__finalization_primitivesS");
   u00141 : constant Version_32 := 16#e8108c8c#;
   pragma Export (C, u00141, "system__os_locksS");
   u00142 : constant Version_32 := 16#fbeae7f4#;
   pragma Export (C, u00142, "system__os_constantsS");
   u00143 : constant Version_32 := 16#9e5df665#;
   pragma Export (C, u00143, "system__file_control_blockS");
   u00144 : constant Version_32 := 16#377f12dc#;
   pragma Export (C, u00144, "project_toolsS");
   u00145 : constant Version_32 := 16#13638c8a#;
   pragma Export (C, u00145, "project_tools__processesB");
   u00146 : constant Version_32 := 16#aa596acf#;
   pragma Export (C, u00146, "project_tools__processesS");
   u00147 : constant Version_32 := 16#85b92d20#;
   pragma Export (C, u00147, "ada__directoriesB");
   u00148 : constant Version_32 := 16#c1305a6c#;
   pragma Export (C, u00148, "ada__directoriesS");
   u00149 : constant Version_32 := 16#78511131#;
   pragma Export (C, u00149, "ada__calendarB");
   u00150 : constant Version_32 := 16#c907a168#;
   pragma Export (C, u00150, "ada__calendarS");
   u00151 : constant Version_32 := 16#d172d809#;
   pragma Export (C, u00151, "system__os_primitivesB");
   u00152 : constant Version_32 := 16#13d50ef9#;
   pragma Export (C, u00152, "system__os_primitivesS");
   u00153 : constant Version_32 := 16#c1ef1512#;
   pragma Export (C, u00153, "ada__calendar__formattingB");
   u00154 : constant Version_32 := 16#5a9d5c4e#;
   pragma Export (C, u00154, "ada__calendar__formattingS");
   u00155 : constant Version_32 := 16#974d849e#;
   pragma Export (C, u00155, "ada__calendar__time_zonesB");
   u00156 : constant Version_32 := 16#55da5b9f#;
   pragma Export (C, u00156, "ada__calendar__time_zonesS");
   u00157 : constant Version_32 := 16#0a4a0a25#;
   pragma Export (C, u00157, "system__val_fixed_64S");
   u00158 : constant Version_32 := 16#afdc38b2#;
   pragma Export (C, u00158, "system__arith_64B");
   u00159 : constant Version_32 := 16#509fabdd#;
   pragma Export (C, u00159, "system__arith_64S");
   u00160 : constant Version_32 := 16#aa0160a2#;
   pragma Export (C, u00160, "system__val_intS");
   u00161 : constant Version_32 := 16#5da6ebca#;
   ...
   u00165 : constant Version_32 := 16#c83084cc#;
   pragma Export (C, u00165, "system__atomic_countersS");
   u00166 : constant Version_32 := 16#1dec9118#;
   pragma Export (C, u00166, "ada__directories__hierarchical_file_namesB");
   u00167 : constant Version_32 := 16#34d5eeb2#;
   pragma Export (C, u00167, "ada__directories__hierarchical_file_namesS");
   u00168 : constant Version_32 := 16#ab4ad33a#;
   pragma Export (C, u00168, "ada__directories__validityB");
   u00169 : constant Version_32 := 16#0877bcae#;
   pragma Export (C, u00169, "ada__directories__validityS");
   u00170 : constant Version_32 := 16#4259a79c#;
   pragma Export (C, u00170, "ada__strings__unboundedB");
   u00171 : constant Version_32 := 16#b40332b4#;
   pragma Export (C, u00171, "ada__strings__unboundedS");
   u00172 : constant Version_32 := 16#d79db92c#;
   pragma Export (C, u00172, "system__return_stackS");
   u00173 : constant Version_32 := 16#756a1fdd#;
   pragma Export (C, u00173, "system__stream_attributesB");
   u00174 : constant Version_32 := 16#a8236f45#;
   pragma Export (C, u00174, "system__stream_attributesS");
   u00175 : constant Version_32 := 16#1c617d0b#;
   pragma Export (C, u00175, "system__stream_attributes__xdrB");
   u00176 : constant Version_32 := 16#e4218e58#;
   pragma Export (C, u00176, "system__stream_attributes__xdrS");
   u00177 : constant Version_32 := 16#d71ab463#;
   pragma Export (C, u00177, "system__fat_fltS");
   u00178 : constant Version_32 := 16#f128bd6e#;
   pragma Export (C, u00178, "system__fat_lfltS");
   u00179 : constant Version_32 := 16#8bf81384#;
   pragma Export (C, u00179, "system__fat_llfS");
   u00180 : constant Version_32 := 16#aaf681ed#;
   ...
   u00182 : constant Version_32 := 16#371accc3#;
   ...
   u00184 : constant Version_32 := 16#8e431254#;
   pragma Export (C, u00184, "system__storage_poolsS");
   u00185 : constant Version_32 := 16#b1e8a6ae#;
   pragma Export (C, u00185, "project_tools__filesB");
   u00186 : constant Version_32 := 16#8734643b#;
   pragma Export (C, u00186, "project_tools__filesS");
   u00187 : constant Version_32 := 16#8d235f7e#;
   pragma Export (C, u00187, "ada__environment_variablesB");
   u00188 : constant Version_32 := 16#767099b7#;
   pragma Export (C, u00188, "ada__environment_variablesS");
   u00189 : constant Version_32 := 16#58c21abc#;
   pragma Export (C, u00189, "interfaces__c__stringsB");
   u00190 : constant Version_32 := 16#bd4557ce#;
   pragma Export (C, u00190, "interfaces__c__stringsS");
   u00191 : constant Version_32 := 16#2252a12d#;
   pragma Export (C, u00191, "ada__streams__stream_ioB");
   u00192 : constant Version_32 := 16#5dc4c9e4#;
   pragma Export (C, u00192, "ada__streams__stream_ioS");
   u00193 : constant Version_32 := 16#5de653db#;
   pragma Export (C, u00193, "system__communicationB");
   u00194 : constant Version_32 := 16#bb9c8d3c#;
   pragma Export (C, u00194, "system__communicationS");
   u00195 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00195, "gnatS");
   u00196 : constant Version_32 := 16#40fe4806#;
   pragma Export (C, u00196, "gnat__regexpS");
   u00197 : constant Version_32 := 16#3f48f1e0#;
   pragma Export (C, u00197, "project_tools__linksB");
   u00198 : constant Version_32 := 16#e9bbd0e5#;
   pragma Export (C, u00198, "project_tools__linksS");
   u00199 : constant Version_32 := 16#656efae9#;
   pragma Export (C, u00199, "gnat__os_libS");
   ...
   u00202 : constant Version_32 := 16#ae5b86de#;
   pragma Export (C, u00202, "system__pool_globalB");
   u00203 : constant Version_32 := 16#a07c1f1e#;
   pragma Export (C, u00203, "system__pool_globalS");
   u00204 : constant Version_32 := 16#0ddbd91f#;
   pragma Export (C, u00204, "system__memoryB");
   u00205 : constant Version_32 := 16#0cbcf715#;
   pragma Export (C, u00205, "system__memoryS");
   u00206 : constant Version_32 := 16#690693e0#;
   pragma Export (C, u00206, "system__storage_pools__subpoolsB");
   u00207 : constant Version_32 := 16#23a252fc#;
   pragma Export (C, u00207, "system__storage_pools__subpoolsS");
   u00208 : constant Version_32 := 16#3676fd0b#;
   pragma Export (C, u00208, "system__storage_pools__subpools__finalizationB");
   u00209 : constant Version_32 := 16#54c94065#;
   pragma Export (C, u00209, "system__storage_pools__subpools__finalizationS");
   u00210 : constant Version_32 := 16#b3f7543e#;
   pragma Export (C, u00210, "system__strings__stream_opsB");
   u00211 : constant Version_32 := 16#46dadf54#;
