...
| `CryptoLib.Certificates` | X.509: local CA, server/client/email issuance, CSR signing, issuance for a key you already hold (which is how RSA certificates are issued), PKCS#12, fingerprints; generated keys are Ed25519, P-256/P-384 or Ed448; issued certificates carry a random serial, a validity window from the clock, and key identifiers |
