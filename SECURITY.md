...
| PKCS#8 private keys | two-prime RSA, Ed25519, Ed448, P-256/384/521 | a multi-prime RSA key is refused rather than read as two of its primes: RFC 3447 marks those version 1 and puts the extra primes after the CRT fields, and a reader taking exactly two reported a p and q of 86 octets each against a 257-octet modulus whose product was not the modulus -- accepted, mis-described, and failing only later as a signature the public-exponent check refused |
