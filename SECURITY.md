...
| Finite-field DH | groups 1 / 14 / 16 / 18 | live vs OpenSSH; group16/18 pin the exact RFC 3526 primes, and group16 refuses a peer public value outside (1, p-1) -- zero and one yield a shared secret of zero or one whatever the private exponent is, which a round-trip test cannot notice |
